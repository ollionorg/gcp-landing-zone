...
| <a name="input_bu_app_deploy_group"></a> [bu\_app\_deploy\_group](#input\_bu\_app\_deploy\_group) | Google Group for GCP deploy group | `string` | n/a | yes |
...
| <a name="input_cfo_group"></a> [cfo\_group](#input\_cfo\_group) | Google Workspace or Cloud Identity group billing data users. | `string` | n/a | yes |
...
| <a name="output_cto_security_operations_group"></a> [cto\_security\_operations\_group](#output\_cto\_security\_operations\_group) | User groups |
