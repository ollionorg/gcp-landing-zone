...
#env logging project
resource "google_project_iam_member" "staging_logging" {
...
resource "google_project_iam_member" "staging_monitoring" {
...
#env secrets project
resource "google_project_iam_member" "staging_secrets" {
