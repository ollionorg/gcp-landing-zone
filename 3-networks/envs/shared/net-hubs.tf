...
module "base_shared_vpc" {
  ...
  subnets = [
    {
      subnet_name           = "sb-${local.shared_environment_code}-shared-base-hub-${local.default_region1}"
    ...
    {
      subnet_name           = "sb-${local.shared_environment_code}-shared-base-hub-${local.default_region2}"
...
module "restricted_shared_vpc" {
  ...
  subnets = [
    {
      subnet_name           = "sb-${local.shared_environment_code}-shared-restricted-hub-${local.default_region1}"
    ...
    {
      subnet_name           = "sb-${local.shared_environment_code}-shared-restricted-hub-${local.default_region2}"
