...
module "restricted_shared_vpc" {
  ...
  subnets = [
    {
      subnet_name           = "sb-${local.environment_code}-shared-restricted-${local.default_region1}"
  ...
  secondary_ranges = {
    "sb-${local.environment_code}-shared-restricted-${local.default_region1}" = local.restricted_subnet_secondary_ranges[local.default_region1]
  }
...
module "base_shared_vpc" {
  ...
  secondary_ranges = {
    "sb-${local.environment_code}-shared-base-${local.default_region1}" = local.base_subnet_secondary_ranges[local.default_region1]
  }
