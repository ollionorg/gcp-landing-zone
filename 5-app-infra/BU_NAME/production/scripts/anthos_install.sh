...
terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production init
export PROJECT_ID=$(terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production output -raw boa_project_id)
export CLUSTER_1_NAME=$(terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production output -raw gke_cluster_region1)
export CLUSTER_1_REGION=$(terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production output -raw gke_cluster1_region)
export CLUSTER_2_NAME=$(terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production output -raw gke_cluster_region2)
export CLUSTER_2_REGION=$(terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production output -raw gke_cluster2_region)
...
terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production init
export INSTANCE_CONNECTION_NAME=$(terraform -chdir=REPO_NAME/5-app-infra/BU_NAME/production output -raw sql_connection)
