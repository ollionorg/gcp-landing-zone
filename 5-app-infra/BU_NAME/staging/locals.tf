locals {
  ...
  project_service_account   = data.terraform_remote_state.BU_NAME_staging.outputs.base_shared_vpc_project_sa
  ...
  base_shared_vpc_project   = data.terraform_remote_state.BU_NAME_staging.outputs.base_shared_vpc_project
  base_shared_vpc_project_number = data.terraform_remote_state.BU_NAME_staging.outputs.base_shared_vpc_project_number
