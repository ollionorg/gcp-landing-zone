...
1. Ensure wrapper script can be executed.
   ...
   ```
1. Rename `common.auto.example.tfvars` to `common.auto.tfvars` and update the file with values from your environment and 0-bootstrap. See any of the business unit 1 envs folders [README.md](BU_NAME/development/README.md) files for additional information on the values in the `common.auto.tfvars` file.
