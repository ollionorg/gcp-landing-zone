package rules.tf_google_compute_firewall_port_135
...
__rego__metadoc__ := {
	...
	"description": "Network firewall rules should not permit ingress from 0.0.0.0/0 to port 135 (RPC). It reduces a server's exposure to risk.",
	"title": "Network firewall rules should not permit ingress from 0.0.0.0/0 to port 135 (RPC)",
}
