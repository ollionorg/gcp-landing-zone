package rules.tf_google_compute_firewall_port_3306
...
__rego__metadoc__ := {
	...
	"description": "Network firewall rules should not permit ingress from 0.0.0.0/0 to port 3306 (DB). It reduces a server's exposure to risk.",
	"title": "Network firewall rules should not permit ingress from 0.0.0.0/0 to port 3306 (DB)",
}
